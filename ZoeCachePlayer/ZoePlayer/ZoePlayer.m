...
#import "ZoeloaderURLSesstion.h"

NSString *const PlayerStateChangedNotification    = @"layerStateChangedNotification";
NSString *const PlayerProgressChangedNotification = @"layerProgressChangedNotification";
NSString *const PlayerLoadProgressChangedNotification = @"layerLoadProgressChangedNotification";

@interface ZoePlayer()<loaderURLConnectionDelegate>
...
@property (nonatomic, strong) ZoeloaderURLSesstion *resouerLoader;
...
- (void)playWithUrl:(NSURL *)url showView:(UIView *)showView
{
    ...
    if (![str hasPrefix:@"http"]) {
        ...
        self.resouerLoader          = [[ZoeloaderURLSesstion alloc] init];
    ...
    if ([url.scheme isEqualToString:@"file"]) {
        ...
        if (self.state == PlayerStatePlaying) {
            [[NSNotificationCenter defaultCenter] postNotificationName:PlayerStateChangedNotification object:nil];
        } else {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:PlayerProgressChangedNotification object:nil];
...
- (void)setLoadedProgress:(CGFloat)loadedProgress
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:PlayerLoadProgressChangedNotification object:nil];
}
